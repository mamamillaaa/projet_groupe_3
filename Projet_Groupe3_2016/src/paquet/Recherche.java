...
//fonction qui affiche le nombre de sous dossier contenue dans le lien donné
	public  void afficheConsole(String directoryPath) {
		...
		if(!directory.exists()){
			...
			String message = "Le répertoire '"+directoryPath+"' contient "+ subfiles.length+" dossier"+(subfiles.length>1?"s":"");
